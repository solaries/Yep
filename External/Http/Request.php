...
class Request
{
    ...
    public function __construct($yeppayObj = null)
    {
        $this->response = new Response();
        $this->response->setRequestObject($this);
        $this->yeppayObj = $yeppayObj;
        $this->response->forApi = !is_null($yeppayObj);
    ...
    {
        if (isset($this->yeppayObj) && !$this->yeppayObj->use_guzzle) {
    ...
    {
        if (!YepPay::$fallback_to_file_get_contents) {
            return;
        }
